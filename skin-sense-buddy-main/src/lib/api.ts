...
export const profiles = {
  ...
  update: async (data: any) =>
    fetchWithAuth('/profiles', { method: 'PUT', body: JSON.stringify(data) }),
};
...
export const cart = {
  ...
  update: async (id: string, quantity: number) =>
    fetchWithAuth(`/cart/${id}`, {
      method: 'PUT',
      body: JSON.stringify({ quantity }),
    }),
  remove: async (id: string) => fetchWithAuth(`/cart/${id}`, { method: 'DELETE' }),
};
...
export const formulations = {
  ...
  generate: async (diagnosisId: string) =>
    fetchWithAuth('/formulations/generate', {
      method: 'POST',
