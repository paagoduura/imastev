...
export default function SalonBooking() {
  ...
  const resetSalonScroll = () => {
    bookingTopRef.current?.scrollIntoView({ block: "start", behavior: "auto" });
      ...
      <div ref={pageTopRef} className="pt-24 pb-16 transition-all">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            {step === 1 && (
              <div key="salon-step-1" className="space-y-8 animate-fade-in">
                ...
                {servicesLoading ? (
                  ...
                  <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
                    <div className="space-y-8">
                      {Object.entries(groupedServices).map(([category, categoryServices]) => (
                        <div key={category}>
                              ...
                              >
                                <CardContent className="p-5">
                                  <div className="flex justify-between items-start mb-3 gap-2">
                                    ...
                                    {selectedServices.some((item) => item.id === service.id) && (
                                      <Badge className="bg-amber-600 text-white">Selected</Badge>
                                    )}
                                    {category === 'Premium' && (
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="font-bold text-lg bg-gradient-to-r from-amber-700 to-stone-600 bg-clip-text text-transparent">
                          ...
                          <div className="lg:hidden mt-4 rounded-2xl border border-amber-200 bg-white p-4 shadow-xl space-y-3">
                            <div>
                              <p className="text-sm font-medium text-muted-foreground">Continue after {category}</p>
                            ...
                            <Button
                              ...
                              className="w-full bg-gradient-to-r from-amber-500 to-amber-700 text-white"
                            >
                              Continue
                    ...
                    <aside className="hidden lg:block lg:sticky lg:top-28 h-fit">
                      <div className="rounded-2xl border border-amber-200 bg-white p-5 shadow-xl space-y-4">
                        <div>
                          <p className="text-sm font-medium text-muted-foreground">Selection summary</p>
            ...
            {step === 2 && (
              <div key="salon-step-2" className="animate-fade-in">
                <Button
                  variant="ghost"
                  onClick={() => setStep(1)}
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
                  <div className="space-y-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedServices.map((service) => (
                            <Badge
                              key={`chip-${service.id}`}
                              variant="secondary"
                              className="flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-stone-800"
                            >
                              <span>{service.name}</span>
                              <button
                                type="button"
                                onClick={() => removeSelectedService(service.id)}
                                className="rounded-full p-0.5 text-stone-700 transition-colors hover:bg-amber-200"
                    ...
                    {selectedServices.length > 0 && (
                      <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-stone-50 border border-amber-100 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-stone-500 flex items-center justify-center">
                                ...
                                {availableSlots.map((slot, index) => {
                                  ...
                                  return (
                                    <Button
                                      ...
                                      className={`relative ${
                                        selectedSlot === slot
                                          ? 'bg-gradient-to-r from-amber-500 to-stone-600 text-white border-0'
                                          : isPriority
                  ...
                  <aside className="lg:sticky lg:top-28 h-fit">
                    <div className="rounded-2xl border border-amber-200 bg-white p-5 shadow-xl space-y-4">
                      ...
                      <Button
                        ...
                        className="w-full bg-gradient-to-r from-amber-500 to-amber-700 hover:from-ambers-600 hover:to-amber-800 text-white"
                      >
                        Continue
                        <ChevronRight className="w-5 h-5 ml-2" />
                      </Button>
            ...
            {step === 3 && (
              <div key="salon-step-3" className="animate-fade-in">
                <Button 
                  variant="ghost" 
                  onClick={() => setStep(2)}
                  className="mb-6 text-muted-foreground hover:text-foreground"
