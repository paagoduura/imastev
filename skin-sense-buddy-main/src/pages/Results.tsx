...
${treatmentPlan.recommendations || 'Follow the care routine outlined in your IMSTEV notes.'}
...
`;
  ...
  const fetchResults = async () => {
    try {
      ...
      const scanData = (await scanResponse.json()) as ScanRecord | null;
  ...
  const handlePayForResults = async () => {
    ...
    try {
      ...
      sessionStorage.setItem('paymentOption', 'one-time');
      ...
      switch (level) {
        case 'self_care':
          return {
            ...
            description: 'This can be managed with a steady hair care routine and suitable products. Follow the care notes below.'
          };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-primary-light/10 to-background flex items-center justify-center p-4">
        <Card className="max-w-md">
          <CardContent className="pt-6 text-center">
            <AlertCircle className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
            <h3 className="text-lg font-semibold mb-2">Analysis is still processing</h3>
            <p className="text-muted-foreground mb-6">
              Your payment is confirmed, but the specialist analysis has not finished yet. Please check back shortly.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button onClick={() => scanId && fetchResults()}>Refresh results</Button>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-xl bg-gradient-to-r from-purple-700 to-amber-600 bg-clip-text text-transparent">
                    IMSTEV NATURALS Care Notes
                  </CardTitle>
                  <CardDescription>Premium organic products selected for your hair type</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm">Treatment Plans</h4>
        ...
        {!isHairAnalysis && diagnosis.conditions && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ordered by confidence level with supporting notes</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {diagnosis.conditions.map((condition: AnalysisCondition, index: number) => (
        ...
        {treatmentPlan && (
          <Card className="border-primary/30">
            <CardHeader>
              ...
              <CardDescription>Care notes based on your assessment</CardDescription>
            </CardHeader>
