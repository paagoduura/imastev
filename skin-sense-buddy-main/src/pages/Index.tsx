    ...
    <div className="page-shell">
      ...
      <main>
        ...
        <section className="olive-section py-16 sm:py-24">
          <div className="container-wide">
            <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr] lg:gap-20">
              <div><p className="text-[11px] font-bold uppercase tracking-[.24em] text-[#d9b277]">IMSTEV NATURALS organic products</p><h2 className="mt-4 text-4xl leading-[.98] tracking-[-.05em] sm:text-6xl">Nature-led care for every routine.</h2><p className="mt-6 max-w-md text-base leading-8 text-[#f8f2e8]/68">Discover Nigerian-made organic essentials for your hair, skin, and everyday care routines—selected to make choosing simpler, richer, and more like you.</p><button type="button" className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#f2d2a6] px-6 py-3.5 text-sm font-bold text-[#24160d] transition hover:-translate-y-0.5 hover:bg-[#ffe0b5]" onClick={() => navigate("/shop")}>Shop organic products <ShoppingBag size={16} /></button></div>
              <div className="grid gap-4 sm:grid-cols-2"><div className="relative min-h-[330px] overflow-hidden rounded-[1.7rem] bg-[#b98258]"><img src="/imstev-products.jpg" alt="IMSTEV NATURALS organic hair and skin products" className="absolute inset-0 h-full w-full object-cover" /><div className="image-overlay absolute inset-0" /><div className="absolute bottom-6 left-6 right-6"><span className="text-[10px] font-bold uppercase tracking-[.18em] text-white/70">Organic care</span><p className="mt-2 font-serif text-3xl leading-none text-white">Made for your routine.</p></div></div><div className="flex min-h-[330px] flex-col justify-between rounded-[1.7rem] bg-[#f0dfc8] p-7 text-[#24160d]"><div><span className="text-[10px] font-bold uppercase tracking-[.18em] text-[#a45a2a]">IMSTEV NATURALS</span><p className="mt-3 font-serif text-4xl leading-[.95] tracking-[-.04em]">Organic products, thoughtfully chosen.</p></div><div><div className="mb-5 flex items-center gap-2 text-xs font-bold uppercase tracking-[.16em] text-[#b9784a]"><CircleCheck size={15} /> Our care promise</div><p className="text-sm leading-6 text-[#6e5b4c]">“Nigerian-rooted essentials made to help your hair and skin feel cared for every day.”</p><p className="mt-4 text-xs font-bold uppercase tracking-[.16em] text-[#a45a2a]">— IMSTEV NATURALS</p></div></div></div>
            </div>
          </div>
        </section>
